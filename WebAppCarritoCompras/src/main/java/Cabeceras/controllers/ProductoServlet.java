        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            productos.forEach(producto -> {
                ...
                if (usernameOptional.isPresent()) {
                    ...
                    out.print("<td><a href=\"" + req.getContextPath() + "/carro/agregar?id="+producto.getId() + "\"> &nbsp;&nbsp;+</a></td>");
                    out.print("<td><a href=\"" + req.getContextPath() + "/carro/eliminar?id="+producto.getId() + "\"> &nbsp;&nbsp;-</a></td>");
                }
                out.print("</tr>");
            });
            out.print("</table>");
            ...
            out.print("<p>" + mensajeApp);
            out.print("<p>" + mensajeRequest);
            out.print(" </body>");
            out.print("</html>");
        }
    }
